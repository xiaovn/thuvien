...
<?php require_once "nav.php";?>
    ...
    <a href="#" title="Danh mucj">
        <div class="hc_box_title">
            ...
            <div class="hc_box_title_center"><?php echo general::getInstance()->get_grade($grade);?></div>
                ...
                <div class="lng_right_top">
                    <table width="100%">
                        <tr valign="middle" height="77">
                            <td>
                                <div class="lng_right_tit"><a href="http://thuviengiaoduc.org/view/doc/<?php echo general::getInstance()->permalink($lb->bookid,'book');?>" title=""><?php echo $lb->bookname;?></a></div>
