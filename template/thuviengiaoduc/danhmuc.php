                        ...
                        <div class="hc_box lng_box">
                            ...
                            <a href="#" title="Danh mục">
                                <div class="hc_box_title">
                                    ...
                                    <div class="hc_box_title_center"><?php echo general::getInstance()->get_category($cat);?></div>
                                ...
                                foreach($listbook as $lb)
                                {
                                    ...
                                    <li>
                                        <div class="lng_img ptl_img">
                                            <a href="#" title="">
                                                <img width="115" height="92" src="http://thuviengiaoduc.org/upload/thumb/<?php echo $lb->bookimage?>"/>
                                            </a>
                                        </div>
                                            ...
                                            <div class="lng_right_top">
                                                <table width="100%">
                                                    <tr valign="middle" height="77">
                                                        <td>
                                                            <div class="lng_right_tit"><a href="http://thuviengiaoduc.org/view/category/<?php echo general::getInstance()->permalink($lb->bookid,'book')?>" title=""><?php echo $lb->bookname;?></a></div>
                                                            <div class="lng_right_content">
                                                                <?php echo substr($lb->bookcontent,0,99);?>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
