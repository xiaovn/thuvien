...
(function($) {
    ...
    $.fn.extend({
        ...
        isDraggable: function(options) {
            if ((!$(this).draggable)) {
                //console.log('To use the isDraggable method you need to load jquery-ui.js'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/spritely-master/To use the isDraggable method you need to load jquery-ui.js*/);
                return this;
            }
            var options = $.extend({
                type: 'isDraggable',
