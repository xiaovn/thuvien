...
createGame.prototype.select_item = function(drop) {
...
$(document).ready(function() {
	...
	gameSentence.sound_none_goldenkids = createSound(src_sentence + 'audios/none_goldelkilds', '', '#audio_sentence');
	...
	$(document).bind('init_game', function() {
		$('.box_q_button').each(function(index, element) {
    ...
    $(document).bind('sen_none_goldenkids',function(){
	   playSound(gameSentence.sound_none_goldenkids,0);
