    ...
    $('#clfpsm').live('mousedown',function(){
        if($('#clfp').data('clfp').selected == true){
            ...
            if($('.clfpts').eq($('#clfp').data('clfp').index).find('.clfptslAca').attr('cr')){
                ...
                var $html = '<span id="clfpir"><img src="tick-7.png"/*tpa=http://www.thuviengiaoduc.org/file/learn/child/learn_through_stories/dungchung/clfpt/img/tick.png*/ width="15" height="15" /></span> Your answer: <span id="clfpir">Correct</span>'
                $('#clfptrs').empty().append($html);
            }else{
                $('#_Aincorrect').jPlayer('play');
                var $html = '<span id="clfpir"><img src="cross-7.png"/*tpa=http://www.thuviengiaoduc.org/file/learn/child/learn_through_stories/dungchung/clfpt/img/cross.png*/ width="12" height="13" /></span> Your answer: <span id="clfpincr">Incorrect</span>'
                $('#clfptrs').empty().append($html);
            }
        ...
        $('.clfpts').each(function(index, domobj){
            ...
            if($this.attr('answer')){
                if($this.find('.clfptslAca').attr('cr')){
                    $('.clfpors').eq(index).append('<img src="tick-7.png"/*tpa=http://www.thuviengiaoduc.org/file/learn/child/learn_through_stories/dungchung/clfpt/img/tick.png*/ width="15" height="15" />');
                    $('.clfposc').eq(index).text($('#clfp').data('clfp').score);
                }else{
                    $('.clfpors').eq(index).append('<img src="cross-7.png"/*tpa=http://www.thuviengiaoduc.org/file/learn/child/learn_through_stories/dungchung/clfpt/img/cross.png*/ width="12" height="13" />');
