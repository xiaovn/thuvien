...
function SoundManager(smURL, smID) {
  ...
  this.play = function(sID, oOptions) {
    ...
    var result = null,
        // legacy function-overloading use case: play('mySound', 'some.mp3.htm'/*tpa=http://www.thuviengiaoduc.org/path/to/some.mp3*/);
    ...
    if (!idCheck(sID, overloaded)) {
      ...
      if (oOptions && oOptions.url) {
        // overloading use case, create+play: .play('someID', {url:'to.mp3.htm'/*tpa=http://www.thuviengiaoduc.org/path/to.mp3*/});
  ...
  html5CanPlay = function(o) {
     ...
     * o = {
     *  url: 'an.mp3.htm'/*tpa=http://www.thuviengiaoduc.org/path/to/an.mp3*/,
     *  type: 'audio/mp3'
     * }
     */
  ...
  setVersionInfo = function() {
    ...
    var isDebug = (sm2.debugMode || sm2.debugFlash?'_debug.swf'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/smg/_debug.swf*/:'.swf');
    ...
    sm2.movieURL = (fV === 8?'soundmanager2.swf'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/smg/soundmanager2.swf*/:'soundmanager2_flash9.swf'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/smg/soundmanager2_flash9.swf*/).replace('.swf', isDebug);
  ...
  initDebug = function() {
    ...
    if (sm2.debugMode && !id(sm2.debugID) && (!hasConsole || !sm2.useConsole || !sm2.consoleOnly)) {
      ...
      oToggle = {
        ...
        'bottom': '0px',
        'right': '0px',
        'width': '1.2em.htm'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/smg/1.2em*/,
        'height': '1.2em.htm'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/smg/1.2em*/,
        'lineHeight': '1.2em.htm'/*tpa=http://www.thuviengiaoduc.org/file/learn/child/dungchung/lib_new_en/smg/1.2em*/,
        'margin': '2px',
        'textAlign': 'center',
